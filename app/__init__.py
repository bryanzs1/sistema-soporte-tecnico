...
TRANSLATIONS = {
    'es': {
        ...
        'Ask me about password, VPN, printers, email, or general technical issues.': 'Pregúntame sobre contraseña, VPN, impresoras, correo o incidencias técnicas generales.',
        'Open support assistant': 'Abrir asistente de soporte',
        ...
        'Create ticket with this context': 'Crear ticket con este contexto',
        'I need help resetting my password': 'Necesito ayuda para restablecer mi contraseña',
        'I cannot connect to the VPN': 'No puedo conectarme a la VPN',
        'My printer is not working': 'Mi impresora no funciona',
        'I am not receiving emails': 'No estoy recibiendo correos',
        'Password reset': 'Restablecer contraseña',
        'VPN access': 'Acceso VPN',
        'Printer issue': 'Problema de impresora',
        'Email issue': 'Problema de correo',
        'Please describe your issue in a bit more detail so I can help you better.': 'Describe un poco mejor tu problema para que pueda ayudarte.',
        "I couldn't find a precise answer yet, but I can help you create a ticket with the information you've already typed.": 'Aún no encontré una respuesta precisa, pero puedo ayudarte a crear un ticket con la información que ya escribiste.',
        'I could not process your request right now. Please create a ticket and a technician will help you.': 'No pude procesar tu solicitud en este momento. Crea un ticket y un técnico te ayudará.',
        ...
        'Take ticket': 'Tomar ticket',
        'Release ticket': 'Liberar ticket',
        'Need to return this ticket to the queue?': '¿Necesitas devolver este ticket a la cola?',
        'Releasing it will remove the assigned technician and set the ticket back to open.': 'Al liberarlo se quitará el técnico asignado y el ticket volverá a abierto.',
        'Ticket released by {username} and returned to the unassigned queue': 'Ticket liberado por {username} y devuelto a la cola sin asignar',
        ...
        'Closed tickets cannot be released': 'Los tickets cerrados no se pueden liberar',
        'This ticket is waiting for a technician': 'Este ticket está esperando un técnico',
        'You can take ownership of this ticket and start working on it immediately.': 'Puedes tomar este ticket y empezar a trabajarlo de inmediato.',
        'Ticket taken by technician {username}': 'Ticket tomado por el técnico {username}',
        'You have taken ticket #{id} successfully': 'Has tomado el ticket #{id} correctamente',
        ...
        'Closed tickets cannot be taken': 'Los tickets cerrados no se pueden tomar',
        ...
        'Support team started working on the ticket': 'El equipo de soporte comenzó a trabajar en el ticket',
        'Resolved': 'Resuelto',
        'Ticket marked as closed': 'Ticket marcado como cerrado',
        'Ticket created by {name}': 'Ticket creado por {name}',
        'No timeline data available yet': 'Aún no hay eventos en la línea de tiempo',
        'Need more help?': '¿Necesitas más ayuda?',
        'You can reopen this ticket with a reason so the team can continue support.': 'Puedes reabrir este ticket con un motivo para que el equipo continúe el soporte.',
        'Reopen ticket': 'Reabrir ticket',
        'Only closed tickets can be reopened': 'Solo se pueden reabrir tickets cerrados',
        'Please provide a short reason to reopen the ticket': 'Por favor ingresa un motivo breve para reabrir el ticket',
        'Reopen reason: {reason}': 'Motivo de reapertura: {reason}',
        'Ticket reopened successfully': 'Ticket reabierto correctamente',
        'Ticket reopened notification': 'Notificación de ticket reabierto',
        'Ticket #{id} was reopened by {user}. Reason: {reason}': 'El ticket #{id} fue reabierto por {user}. Motivo: {reason}',
        'Reopen available until': 'Reapertura disponible hasta',
        'Reopen period expired': 'Período de reapertura vencido',
        'Reopen window expired. Closed tickets can only be reopened within 7 days.': 'Ventana de reapertura vencida. Los tickets cerrados solo pueden reabrirse dentro de 7 días.',
        'Type CERRAR to confirm closing this ticket': 'Escribe CERRAR para confirmar el cierre de este ticket',
        'Ticket close action was cancelled': 'La acción de cierre del ticket fue cancelada',
        'Revoke this API token?': '¿Revocar este token API?',
        'Type REVOCAR to confirm token revocation': 'Escribe REVOCAR para confirmar la revocación del token',
        'This ticket was reopened {count} time(s)': 'Este ticket fue reabierto {count} vez/veces',
        'Quick reply: Acknowledged': 'Respuesta rápida: Acuse recibido',
        'Quick reply: Ask for evidence': 'Respuesta rápida: Solicitar evidencia',
        'Quick reply: Resolution': 'Respuesta rápida: Resolución',
        'Hello, we are reviewing your case and will update you shortly.': 'Hola, estamos revisando tu caso y te actualizaremos en breve.',
        'Please share a screenshot or exact error message so we can continue.': 'Por favor comparte una captura o el mensaje de error exacto para continuar.',
        'Issue resolved. Please confirm if everything is working correctly on your side.': 'Incidente resuelto. Por favor confirma si todo funciona correctamente de tu lado.',
        'Suggested solutions from Knowledge Base': 'Soluciones sugeridas desde la Base de Conocimiento',
        'This field is automatically filled with your account name': 'Este campo se completa automáticamente con el nombre de tu cuenta',
        'Type at least 3 characters in description': 'Escribe al menos 3 caracteres en la descripción',
        'Start typing your issue to see possible solutions': 'Comienza a escribir tu problema para ver posibles soluciones',
        'No related articles found': 'No se encontraron artículos relacionados',
        'Could not load suggestions right now': 'No se pudieron cargar sugerencias en este momento',
        'Status': 'Estado',
        'Priority': 'Prioridad',
        'Category': 'Categoría',
        ...
        'Are you sure you want to permanently delete user': '¿Estás seguro de que deseas eliminar permanentemente al usuario',
        'This action cannot be undone.': 'Esta acción no se puede deshacer.',
        'Existing records will be reassigned to administrator': 'Los registros existentes se reasignarán al administrador',
        'This action cannot be undone. Users with existing records must be deactivated instead.': 'Esta acción no se puede deshacer. Los usuarios con registros existentes deben desactivarse en su lugar.',
        ...
        'User "{username}" has associated records and cannot be deleted. Deactivate the account instead.': 'El usuario "{username}" tiene registros asociados y no puede eliminarse. Desactiva la cuenta en su lugar.',
        'User "{username}" has been permanently deleted.': 'El usuario "{username}" ha sido eliminado permanentemente.',
        'Error deleting user. Please try again.': 'Error al eliminar usuario. Por favor intenta de nuevo.',
        'Type': 'Tipo',
        'Value': 'Valor',
        'Add': 'Agregar',
        'Ticket options': 'Opciones de ticket',
        'Restore recommended options': 'Restaurar opciones recomendadas',
        'Recommended options restored: {count}': 'Opciones recomendadas restauradas: {count}',
        'Ticket options are already up to date': 'Las opciones de ticket ya están actualizadas',
        ...
        'Ticket assignment policy': 'Política de asignación de tickets',
        'Allow technicians to assign or reassign tickets': 'Permitir que los técnicos asignen o reasignen tickets',
        'Technician reassignment enabled': 'Reasignación por técnicos habilitada',
        ...
        'Software': 'Software',
        'Hardware': 'Hardware',
        'Access and accounts': 'Accesos y cuentas',
        'Corporate email': 'Correo corporativo',
        'VPN and remote connectivity': 'VPN y conectividad remota',
        'Telephony and video conferencing': 'Telefonía y videoconferencia',
        'Devices and peripherals': 'Equipos y periféricos',
        'IT security': 'Seguridad informática',
        'Accesos y cuentas': 'Access and accounts',
        'Correo corporativo': 'Corporate email',
        'VPN y conectividad remota': 'VPN and remote connectivity',
        'Telefonía y videoconferencia': 'Telephony and video conferencing',
        'Equipos y periféricos': 'Devices and peripherals',
        ...
        'AI Support Assistant': 'Asistente de soporte con IA',
        'Floating assistant with AI to help resolve technical issues and guide users with actionable steps.': 'Asistente flotante con IA para resolver incidencias técnicas y guiar a los usuarios con pasos accionables.',
        'Guided Ticket Creation': 'Creación guiada de tickets',
        'Turn conversations into prefilled tickets with context, category suggestions, and faster triage.': 'Convierte conversaciones en tickets prellenados con contexto, sugerencias de categoría y triaje más rápido.',
        'Automatic Classification': 'Clasificación automática',
        'Detects categories like VPN, printers, email, accounts, and software to route requests correctly.': 'Detecta categorías como VPN, impresoras, correo, cuentas y software para enrutar solicitudes correctamente.',
        'Operational Dashboard': 'Panel operativo',
        'Track SLAs, ticket states, and support performance with real-time operational visibility.': 'Monitorea SLAs, estados de tickets y desempeño del soporte con visibilidad operativa en tiempo real.',
        ...
        , 'Reject with feedback': 'Rechazar con motivo'
        , 'Enter rejection reason': 'Ingresa el motivo del rechazo'
        , 'Please provide a rejection reason': 'Por favor ingresa un motivo de rechazo'
        , 'Article rejected with feedback': 'Articulo rechazado con retroalimentacion'
        , 'Office 365 email intake settings saved': 'Configuracion de ingreso de correo Office 365 guardada'
        , 'Office 365 Email to Ticket (Optional)': 'Office 365 Correo a Ticket (Opcional)'
        , 'Enable this only for companies that use Office 365. Keep disabled otherwise.': 'Habilita esto solo para empresas que usan Office 365. Mantenlo desactivado en caso contrario.'
        , 'Enable Office 365 email intake': 'Habilitar ingreso de correo Office 365'
        , 'Support mailbox': 'Buzon de soporte'
        , 'Used to validate sender domain when restricted mode is enabled.': 'Se usa para validar el dominio del remitente cuando el modo restringido esta habilitado.'
        , 'Intake endpoint': 'Endpoint de ingreso'
        , 'Use this URL in Power Automate HTTP action.': 'Usa esta URL en la accion HTTP de Power Automate.'
        , 'Allow external senders': 'Permitir remitentes externos'
        , 'If disabled, only sender emails from the same domain as support mailbox are accepted.': 'Si se desactiva, solo se aceptan correos de remitentes del mismo dominio del buzon de soporte.'
        ...
        , 'Delete this ticket permanently?': '¿Eliminar este ticket de forma permanente?'
        ...
        , 'Immutable-style security trail for critical actions. Review regularly.': 'Bitácora de seguridad estilo inmutable para acciones críticas. Revísala regularmente.'
        , 'Action': 'Acción'
        , 'Operations Hub': 'Centro de Operaciones'
        , 'Interactive shortcuts for daily operations': 'Accesos directos interactivos para operaciones diarias'
        , 'Jump to': 'Ir a'
