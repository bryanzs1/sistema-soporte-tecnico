...
# Endpoint para el chat del asistente (responde a peticiones POST con mensaje del usuario)
...
def assistant_chat():
    ...
    response = converse_with_assistant(current_user.id, user_message, lang)
